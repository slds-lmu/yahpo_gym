...
def fit_config(key, embds_dbl=None, embds_tgt=None, tfms=None, lr = 3*1e-4, epochs=100, deep=[512,512,256], deeper=[], dropout=0., wide=True, use_bn=False, frac=1.0, bs=2048, mixup=True, export=False, log_wandb=True, wandb_entity='mfsurrogates'):
    """
...
if __name__ == '__main__':
    ...
    fit_rbv2_glmnet(export = True, lr = 3*1e-4)
    # fit_rbv2_rpart(export = True, lr = 5*1e-4)
