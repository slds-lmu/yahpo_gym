...
_fair_dict = {
    'y_names' : ['mmce', 'f1', 'feo', 'fpredp', 'facc', 'ftpr', 'ffomr', 'ffnr', 'fpp', 'ramtrain', 'rammodel', 'rampredict', 'timetrain', 'timepredict'],
    'y_minimize' : [True, False, True, True, True, True, True, True, True, True, True, True, True, True],
